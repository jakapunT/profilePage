          ...
          <div className="fixed inset-y-0 left-0 w-80 bg-white shadow-xl transform transition-transform duration-300 ease-in-out" onClick={(e) => e.stopPropagation()}>
            <div className="p-6 overflow-y-auto h-full">
              ...
              <div className="text-center mb-6 pt-4">
                <div className="w-28 h-36 mx-auto rounded-lg overflow-hidden shadow-lg mb-4">
                  <img 
                    src="IMG_5438.jpg" 
                    alt="Profile" 
                    className="w-full h-full object-cover"
                ...
                <h1 className="text-lg font-bold text-gray-900 mb-1">Jakapun Tachaiya</h1>
                <p className="text-gray-600 text-xs">Natural Language Processing Researcher</p>
              </div>
